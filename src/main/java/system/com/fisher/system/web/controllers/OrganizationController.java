...
import com.fisher.system.web.models.OrganizationEditModel;
import com.fisher.system.web.models.TreeModel;
import com.fisher.system.web.models.extension.OrganizationModelExtension;
...
public class OrganizationController extends BaseController { 
	...
	public String chain(HttpServletRequest request, Model model){
		if(!model.containsAttribute("contentModel")){		
			...
			model.addAttribute("contentModel", JSONArray.toJSONString(treeModels));
		}
