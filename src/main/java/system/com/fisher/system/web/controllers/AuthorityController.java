...
import com.fisher.system.web.models.AuthorityEditModel;
import com.fisher.system.web.models.TreeModel;
import com.fisher.system.web.models.extension.AuthorityModelExtension;
...
public class AuthorityController extends BaseController { 
	...
	public String chain(HttpServletRequest request, Model model){		
		if(!model.containsAttribute("contentModel")){		
			...
			String jsonString  = JSONArray.toJSONString(treeModels);
